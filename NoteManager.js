...
class NoteManager 
{
    ...
    addNote(title, body) {
        ...
        if (!duplicateNote) {
            ...
            console.log(chalk.green.inverse('New note added!')); // optional
            this.saveNotes();
            return newNote; // <=== needed
            
        } else {
            console.log(chalk.red.inverse('Note title taken!')); // optional
            return null; // <=== if a note already exists
        }
    }
